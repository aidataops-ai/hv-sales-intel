...
def test_me_returns_is_bootstrap_admin_true_for_bootstrap(sample_admin_profile):
    bootstrap_user = {**sample_admin_profile, "email": "boss@healthandvirtuals.com"}
